...
- **Final exam:** Friday, December 18, 2026, 10:30 AM–12:30 PM, outside the regular meeting time. Location and modality will be confirmed on Canvas.
...
- **Midterm 1:** Wednesday, October 14, 2026, 12:20–2:15 PM, in class. Covers Munkres §§1–21.
- **Midterm 2:** Wednesday, November 18, 2026, 12:20–2:15 PM, in class. Covers Munkres §§22–33.
- **Final exam:** Friday, December 18, 2026, 10:30 AM–12:30 PM. Cumulative, with emphasis on material after Midterm 2.

All three exams are held in person and proctored. Because AI tools have made take-home examinations unworkable, no part of any exam may be completed outside the exam room. Books, notes, electronic devices of any kind, internet access, AI tools, and collaboration are all prohibited during exams. Any further details of format will be announced on Canvas.

## Grading Policy

Your numerical score is the larger of the following two computations:
...
**Score 2** (the final exam replaces your weaker midterm)
...
![Two mushrooms above ground, their root systems joined below](/images/arnold-mushrooms.svg)
...
**Recommended uses.** Ask AI to explain a definition in different words, to produce examples and counterexamples, to tell you whether a space you have in mind is a standard one, to suggest which technique a problem might call for, or to find the gap in an argument you have already written. In a course like this one, "give me a space that is limit point compact but not compact" and "here is my proof that a continuous image of a connected space is connected — where does it break down?" are both excellent questions. Working through a problem with AI one step at a time, where you decide the next step and use the model to test your reasoning, is far more valuable than reading a finished solution.

**Discouraged uses.** Please don't paste a homework problem in and ask for the solution, especially before you have made a serious attempt yourself. Being stuck for a while is not a sign that something has gone wrong; it is most of what learning to write proofs consists of. When you do reach for AI, use it to get unstuck, not to get finished.

**Where the line is.** Discouraged uses are advice; this part is a rule. If the mathematical content of a proof you submit came from a model rather than from you, the work is not yours, and submitting it is scholastic dishonesty under the Student Conduct Code, exactly as copying from a classmate would be. Paraphrasing AI output, or having a model produce an outline that you then fill in, falls on the same side of that line. When you use AI in a permitted way on an assignment, add a one-line note at the end saying so, in the same way you acknowledge a classmate you worked with; doing that will never cost you points.

**Your responsibility.** Whatever you submit is yours. You are accountable for its correctness, you must understand every step, and you should be able to reproduce and defend the argument without assistance. I may ask you to explain a submitted solution in office hours. AI output is frequently wrong in ways that look plausible, and point-set topology brings out its worst habits: reversed quantifiers, hypotheses that were never assumed, invented theorem names, and arguments that quietly assume a space is metrizable or Hausdorff. Verify everything against the definitions.

**Exams.** All three exams are in person and closed-book. AI tools of any kind are prohibited, as are notes and electronic devices. Prepare accordingly: exams are 70% of your grade, and the skills they test are exactly the ones you build by working problems yourself.

If you are unsure whether some particular use is permitted, ask me first. I would much rather answer that question in advance than after the fact.
...
| 6 | Oct 14 | Wed | **Midterm 1** (covers §§1–21) |
...
| 11 | Nov 18 | Wed | **Midterm 2** (covers §§22–33) |
| 12 | Nov 23 | Mon | The Urysohn metrization theorem and the Tietze extension theorem (§§34–35) |
| 12 | Nov 25 | Wed | The Tychonoff theorem and compactness of products (§37) |
| 13 | Nov 30 | Mon | Local finiteness and the Nagata–Smirnov metrization theorem (§§39–40) |
| 13 | Dec 2 | Wed | Paracompactness and the Smirnov metrization theorem (§§41–42) |
| 14 | Dec 7 | Mon | Complete metric spaces; compactness in metric spaces (§§43, 45) |
| 14 | Dec 9 | Wed | Pointwise and compact convergence; the Ascoli theorem (§§46–47) |
| 15 | Dec 14 | Mon | Baire spaces and an introduction to dimension theory (§§48, 50) |
| 15 | Dec 16 | Wed | Homotopy of paths; course review (§51) |
| Finals | Dec 18 | Fri | **Final exam**, 10:30 AM–12:30 PM |
