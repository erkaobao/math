...
<p class="ltx_p"><span class="ltx_text ltx_font_bold">Notation.</span> These notes follow J. R. Munkres, <em class="ltx_emph ltx_font_italic">Topology</em></p>
</div>
</li>
</ul>
</div>
...
into the intersection/union statements for closed sets. Draw pictures.</span></span></span></p>
</div>
</li>
